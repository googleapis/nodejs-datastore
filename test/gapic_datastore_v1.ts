...
describe('v1.DatastoreClient', () => {
    ...
    describe('runAggregationQuery', () => {
        it('invokes runAggregationQuery without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.datastore.v1.RunAggregationQueryResponse());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.runAggregationQuery as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
