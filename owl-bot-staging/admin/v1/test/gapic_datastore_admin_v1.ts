...
describe('v1.DatastoreAdminClient', () => {
    ...
    describe('getIndex', () => {
        it('invokes getIndex without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetIndexRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetIndexRequest', ['indexId']);
    ...
    describe('exportEntities', () => {
        it('invokes exportEntities without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ExportEntitiesRequest', ['projectId']);
            request.projectId = defaultValue1;
    ...
    describe('importEntities', () => {
        it('invokes importEntities without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ImportEntitiesRequest', ['projectId']);
            request.projectId = defaultValue1;
            const expectedHeaderRequestParams = `project_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createIndex', () => {
        it('invokes createIndex without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateIndexRequest', ['projectId']);
            request.projectId = defaultValue1;
            const expectedHeaderRequestParams = `project_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('deleteIndex', () => {
        it('invokes deleteIndex without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteIndexRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('DeleteIndexRequest', ['indexId']);
            request.indexId = defaultValue2;
            const expectedHeaderRequestParams = `project_id=${defaultValue1}&index_id=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listIndexes', () => {
        it('invokes listIndexes without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListIndexesRequest', ['projectId']);
            request.projectId = defaultValue1;
