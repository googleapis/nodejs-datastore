...
describe('v1.DatastoreAdminClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new datastoreadminModule.v1.DatastoreAdminClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'datastore.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new datastoreadminModule.v1.DatastoreAdminClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'datastore.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new datastoreadminModule.v1.DatastoreAdminClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new datastoreadminModule.v1.DatastoreAdminClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getIndex', () => {
        it('invokes getIndex without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.datastore.admin.v1.GetIndexRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.datastore.admin.v1.GetIndexRequest', ['indexId']);
    ...
    describe('exportEntities', () => {
        it('invokes exportEntities without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.datastore.admin.v1.ExportEntitiesRequest', ['projectId']);
            request.projectId = defaultValue1;
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.exportEntities as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.exportEntities as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('importEntities', () => {
        it('invokes importEntities without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.datastore.admin.v1.ImportEntitiesRequest', ['projectId']);
            request.projectId = defaultValue1;
            const expectedHeaderRequestParams = `project_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.importEntities as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.importEntities as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('createIndex', () => {
        it('invokes createIndex without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.datastore.admin.v1.CreateIndexRequest', ['projectId']);
            request.projectId = defaultValue1;
            const expectedHeaderRequestParams = `project_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes createIndex without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createIndex(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.datastore.admin.v1.IIndex, protos.google.datastore.admin.v1.IIndexOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.datastore.admin.v1.IIndex, protos.google.datastore.admin.v1.IIndexOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createIndex as SinonStub)
                .getCall(0).args[0];
    ...
    describe('deleteIndex', () => {
        it('invokes deleteIndex without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.datastore.admin.v1.DeleteIndexRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.datastore.admin.v1.DeleteIndexRequest', ['indexId']);
            request.indexId = defaultValue2;
            const expectedHeaderRequestParams = `project_id=${defaultValue1 ?? '' }&index_id=${defaultValue2 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listIndexes', () => {
        it('invokes listIndexes without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.datastore.admin.v1.ListIndexesRequest', ['projectId']);
            request.projectId = defaultValue1;
