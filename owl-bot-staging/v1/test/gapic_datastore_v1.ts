...
describe('v1.DatastoreClient', () => {
    ...
    describe('lookup', () => {
        it('invokes lookup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('LookupRequest', ['projectId']);
    ...
    describe('runQuery', () => {
        it('invokes runQuery without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('RunQueryRequest', ['projectId']);
            request.projectId = defaultValue1;
            const expectedHeaderRequestParams = `project_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('beginTransaction', () => {
        it('invokes beginTransaction without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('BeginTransactionRequest', ['projectId']);
            request.projectId = defaultValue1;
            const expectedHeaderRequestParams = `project_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('commit', () => {
        it('invokes commit without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CommitRequest', ['projectId']);
            request.projectId = defaultValue1;
            const expectedHeaderRequestParams = `project_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('rollback', () => {
        it('invokes rollback without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('RollbackRequest', ['projectId']);
            request.projectId = defaultValue1;
            const expectedHeaderRequestParams = `project_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('allocateIds', () => {
        it('invokes allocateIds without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('AllocateIdsRequest', ['projectId']);
            request.projectId = defaultValue1;
            const expectedHeaderRequestParams = `project_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('reserveIds', () => {
        it('invokes reserveIds without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ReserveIdsRequest', ['projectId']);
            request.projectId = defaultValue1;
            const expectedHeaderRequestParams = `project_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
