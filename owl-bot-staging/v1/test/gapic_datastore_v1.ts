...
describe('v1.DatastoreClient', () => {
    ...
    describe('lookup', () => {
        it('invokes lookup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.datastore.v1.LookupRequest', ['projectId']);
            ...
            const actualRequest = (client.innerApiCalls.lookup as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.lookup as SinonStub)
    ...
    describe('runQuery', () => {
        it('invokes runQuery without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.datastore.v1.RunQueryRequest', ['projectId']);
            request.projectId = defaultValue1;
            const expectedHeaderRequestParams = `project_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.runQuery as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.runQuery as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('runAggregationQuery', () => {
        it('invokes runAggregationQuery without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.datastore.v1.RunAggregationQueryRequest', ['projectId']);
            request.projectId = defaultValue1;
            const expectedHeaderRequestParams = `project_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.datastore.v1.RunAggregationQueryResponse()
            );
            client.innerApiCalls.runAggregationQuery = stubSimpleCall(expectedResponse);
            const [response] = await client.runAggregationQuery(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.runAggregationQuery as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.runAggregationQuery as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes runAggregationQuery without error using callback', async () => {
            ...
            client.innerApiCalls.runAggregationQuery = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.runAggregationQuery(
                    request,
                    (err?: Error|null, result?: protos.google.datastore.v1.IRunAggregationQueryResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes runAggregationQuery with error', async () => {
            ...
            const expectedHeaderRequestParams = `project_id=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.runAggregationQuery = stubSimpleCall(undefined, expectedError);
    ...
    describe('beginTransaction', () => {
        it('invokes beginTransaction without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.datastore.v1.BeginTransactionRequest', ['projectId']);
            request.projectId = defaultValue1;
            const expectedHeaderRequestParams = `project_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('commit', () => {
        it('invokes commit without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.datastore.v1.CommitRequest', ['projectId']);
            request.projectId = defaultValue1;
            const expectedHeaderRequestParams = `project_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('rollback', () => {
        it('invokes rollback without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.datastore.v1.RollbackRequest', ['projectId']);
            request.projectId = defaultValue1;
            const expectedHeaderRequestParams = `project_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('allocateIds', () => {
        it('invokes allocateIds without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.datastore.v1.AllocateIdsRequest', ['projectId']);
            request.projectId = defaultValue1;
            const expectedHeaderRequestParams = `project_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.allocateIds as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.allocateIds as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('reserveIds', () => {
        it('invokes reserveIds without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.datastore.v1.ReserveIdsRequest', ['projectId']);
            request.projectId = defaultValue1;
            const expectedHeaderRequestParams = `project_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.reserveIds as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.reserveIds as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
