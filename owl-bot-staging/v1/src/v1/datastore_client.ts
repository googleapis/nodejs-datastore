...
export class DatastoreClient {
  ...
  initialize() {
    ...
    const datastoreStubMethods =
        ['lookup', 'runQuery', 'runAggregationQuery', 'beginTransaction', 'commit', 'rollback', 'allocateIds', 'reserveIds'];
 ...
 */
  ...
  lookup(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.lookup(request, options, wrappedCallback)
 ...
 */
  ...
  runQuery(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.runQuery(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.datastore.v1.IRunQueryResponse,
 ...
 */
  runAggregationQuery(
      ...
      Promise<[
        ...
        protos.google.datastore.v1.IRunAggregationQueryRequest|undefined, {}|undefined
      ]>;
  runAggregationQuery(
      request: protos.google.datastore.v1.IRunAggregationQueryRequest,
      options: CallOptions,
  ...
  runAggregationQuery(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.runAggregationQuery(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.datastore.v1.IRunAggregationQueryResponse,
 ...
 */
  ...
  allocateIds(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.allocateIds(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.datastore.v1.IAllocateIdsResponse,
 ...
 */
  ...
  reserveIds(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.reserveIds(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.datastore.v1.IReserveIdsResponse,
